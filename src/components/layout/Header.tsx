        ...
        <div className="flex items-center justify-between gap-3">
          ...
          >
            ...
            <div className="flex flex-col min-w-0 leading-none">
              ...
              <span className="text-[8px] sm:text-[10px] font-black text-slate-700 tracking-[0.16em] leading-none mt-0">MULTIMODAL</span>
            </div>
          </button>
          ...
          >
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-[#1e3a8a] text-white flex items-center justify-center group-hover:bg-[#1e40af] transition-colors">
